...
asr_config=myconf/train_asr_parallel_cbs_transducer.yaml
...
init_model="/mnt/aoni04/jsakuma/development/espnet-g05-1.8/egs2/csj_core/asr1/exp/asr_train_asr_cbs_transducer_848_baseline_my_token_list_raw_jp_char_sp/valid.loss_transducer.ave_10best.pth"
